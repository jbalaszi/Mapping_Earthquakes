...
// Data for past seven days of earthquake data.
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(tectonic) {
  console.log(data);  
  L.geoJson(tectonic, {
